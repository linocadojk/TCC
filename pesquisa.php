...
<body>
    ...
    if (isset($_GET['termo_pesquisa'])) {
        ...
        FROM produtos p
        INNER JOIN categorias c ON p.categoria_id = c.id where p.nome LIKE '%$termo_pesquisa%' OR p.descricao LIKE '%$termo_pesquisa%'";
        ...
        if (mysqli_num_rows($result) > 0) {
            ...
            while ($row = mysqli_fetch_assoc($result)) {
                ...
                if (mysqli_num_rows($imagens_result) > 0) {
                    ...
                    echo "<img src=\"admin/" . $primeira_imagem['caminho'] . "\" alt=\"Imagem do Produto\">";
                } else {
